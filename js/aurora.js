/* =========================================================
   AURORA BACKGROUND (ported from React Bits' <Aurora /> to
   vanilla JS since this project has no React/Tailwind).
   Renders an animated WebGL aurora into a container element.
========================================================= */
...
/**
 * Mounts the aurora effect into `container`.
